  ...
  return (
    <>
                ...
                >
                  <div>
                    <input
                      ...
                      onChange={() =>
                        handleTaskDone(taskItems.indexOf(taskItem))
                      }
                    />
                    <span
                  ...
                  <div>
                    <Button
                      onClick={() =>
                        handleEditTask(taskItems.indexOf(taskItem))
                      }
                    >
                      Edit
                    </Button>
                    <Button
                      ...
                      onClick={() =>
                        handleDeleteTask(taskItems.indexOf(taskItem))
                      }
                    >
                      Delete
                    </Button>
      ...
      <div className='text-center text-gray-500 text-sm'>
        <span>Bản quyền thuộc về Tony Entertainment</span>
      </div>
    </>
  );
}
